...
│
├── app/
│   └── bugarai_theme.dart                     # Global dark theme, colors, extensions
│
├── core/
...
2. Add the Android app with package **`com.ahmadapps.bugarai.android`**
...
Currently distributed via **Google Play closed testing** under package `com.ahmadapps.bugarai.android`.
