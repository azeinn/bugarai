          ...
          SizedBox(
            ...
            child: CircularProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                _running ? BugarAITheme.primary : BugarAITheme.muted,
              ),
            ),
          ),
          Column(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: filled ? BugarAITheme.primary : BugarAITheme.card,
          borderRadius: BorderRadius.circular(24),
          border: filled
              ? null
              : Border.all(color: BugarAITheme.muted.withValues(alpha: 0.3)),
        ),
        child: Text(
          label,
          style: TextStyle(
            color: filled ? Colors.white : BugarAITheme.muted,
            fontWeight: FontWeight.w600,
            fontSize: 13,
          ),
        ),
