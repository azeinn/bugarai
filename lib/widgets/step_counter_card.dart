...
class _StepCounterCardState extends State<StepCounterCard>
        ...
        children: [
          ...
          Row(
            children: [
              ...
              if (!_hasPermission)
                IconButton(
                  icon: const Icon(Icons.warning, color: BugarAITheme.warning),
              ...
              children: [
                ...
                CustomPaint(
                  ...
                  painter: _StepProgressPainter(
                    ...
                    progressColor: BugarAITheme.primary,
                    strokeWidth: 12,
                  ),
                ),
                // Center Content
          ...
          Container(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                color: progress >= 1.0 ? BugarAITheme.success : BugarAITheme.primary,
              ),
            ),
          ),
        ],
  ...
  Color _getStatusColor() {
    if (!_hasPermission) return BugarAITheme.warning;
