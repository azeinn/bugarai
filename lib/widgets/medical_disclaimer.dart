    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Row(
          children: [
            Icon(Icons.warning_amber_rounded,
                color: BugarAITheme.warning, size: 20),
            const SizedBox(width: 10),
            Expanded(
              child: Text(
                AppStrings.get('workout_injury_warning'),
                style: const TextStyle(
                    color: BugarAITheme.text, fontSize: 13),
              ),
            ),
          ],
        ),
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
              color: BugarAITheme.warning.withValues(alpha: 0.4)),
        ),
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: BugarAITheme.card.withValues(alpha: 0.95),
                  ...
                  Row(
                    children: [
                      const Icon(Icons.health_and_safety_outlined,
                          color: BugarAITheme.primary, size: 28),
                      const SizedBox(width: 10),
                      const Expanded(
                        child: Text(
                  ...
                  Flexible(
                    child: Scrollbar(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Text(
                          'BugarAI provides general fitness and nutrition guidance '
                              ...
                              'be fully accurate. BugarAI does not verify allergen '
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        ...
                        foregroundColor: BugarAITheme.text,
                        padding: const EdgeInsets.symmetric(vertical: 14),
                        shape: RoundedRectangleBorder(
                          borderRadius:
                          BorderRadius.circular(BugarAITheme.radiusMD),
                        ),
                      ),
                      onPressed: () async {
      ...
      child: Row(
        ...
        children: [
          Icon(Icons.info_outline,
              size: compact ? 14 : 16, color: BugarAITheme.muted),
