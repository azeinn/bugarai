...
class _CaloriesScreenState extends State<CaloriesScreen> {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: const TextStyle(color: BugarAITheme.muted),
                filled: true,
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: selected ? BugarAITheme.primary : Colors.transparent,
                            ),
                          ),
                          child: Text(
                            entry.value,
                            style: TextStyle(
                              color: selected ? BugarAITheme.primary : BugarAITheme.muted,
                              fontSize: 12,
  ...
  InputDecoration _inputDecoration(String label) {
    return InputDecoration(
      labelText: label,
      labelStyle: const TextStyle(color: BugarAITheme.muted),
      filled: true,
      fillColor: BugarAITheme.background,
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(14),
        ...
        children: [
          ...
          IconButton(
            ...
            icon: Container(
              ...
              decoration: BoxDecoration(
                color: BugarAITheme.error.withValues(alpha: 0.15),
                borderRadius: BorderRadius.circular(10),
              ),
              child: const Icon(Icons.remove, color: BugarAITheme.error, size: 18),
            ),
          ),
          Text(
            '$water',
          ...
          IconButton(
            ...
            icon: Container(
              ...
              child: const Icon(Icons.add, color: BugarAITheme.success, size: 18),
            ),
          ),
        ],
      ),
          ...
          Row(
            children: [
              ...
              Text(
                ...
                style: const TextStyle(color: BugarAITheme.muted, fontSize: 11),
              ),
            ],
          ),
          const SizedBox(height: 12),
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: BugarAITheme.primary.withValues(alpha: 0.12),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: const TextStyle(color: BugarAITheme.muted, fontSize: 10),
                      ),
                    ],
                  ),
                ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: entry.source == 'scanner'
                  ? BugarAITheme.primary.withValues(alpha: 0.18)
                  : BugarAITheme.teal.withValues(alpha: 0.18),
              borderRadius: BorderRadius.circular(12),
            ),
            child: Icon(
              sourceIcon,
              color: entry.source == 'scanner' ? BugarAITheme.primary : BugarAITheme.teal,
              size: 18,
            ),
          ),
          ...
          Column(
            ...
            children: [
              Text(
                '${entry.calories} cal',
                style: const TextStyle(fontWeight: FontWeight.bold, color: BugarAITheme.hot),
              ),
              const SizedBox(height: 4),
              PopupMenuButton<String>(
                color: BugarAITheme.cardDark,
                onSelected: (value) {
                ...
                child: const Icon(Icons.more_vert, size: 18, color: BugarAITheme.muted),
              ),
            ],
          ),
        ],
