...
class _MealScannerScreenState extends State<MealScannerScreen>
  ...
  void _showSnackBar(String message, {required bool isError}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? BugarAITheme.error : BugarAITheme.success,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [BugarAITheme.card, BugarAITheme.card2],
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [
                    ...
                    BugarAITheme.teal.withValues(alpha: 0.16),
                  ],
                ...
                boxShadow: [
                  BoxShadow(
                    color: BugarAITheme.primary.withValues(alpha: 0.28),
                    blurRadius: 32,
                    spreadRadius: 4,
                  ),
                ],
  ...
  Widget _buildLoadingCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: BugarAITheme.primary.withValues(alpha: 0.15)),
      ),
      child: Row(
        children: [
          const SizedBox(
  ...
  Widget _buildErrorCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: BugarAITheme.error.withValues(alpha: 0.1),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: BugarAITheme.error.withValues(alpha: 0.3)),
      ),
      child: Row(
        children: [
          const Icon(Icons.error_outline, color: BugarAITheme.error),
          const SizedBox(width: 12),
          Expanded(
            child: Text(
              _error!,
          ...
          if (_selectedImage != null)
            IconButton(
              icon: const Icon(Icons.refresh, color: BugarAITheme.error),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    _analysis!.quantity,
                    style: const TextStyle(color: BugarAITheme.primary, fontSize: 11, fontWeight: FontWeight.w600),
                  ),
                ),
              ],
            ),
          ...
          Column(
            children: [
              ...
              Text(
                ...
                style: TextStyle(color: BugarAITheme.muted, fontSize: 11),
              ),
            ],
          ),
        ],
  ...
  Widget _buildHealthTip() {
    ...
    final tone = healthy ? BugarAITheme.success : BugarAITheme.warning;
