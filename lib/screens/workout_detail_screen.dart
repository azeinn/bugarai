...
class WorkoutDetailScreen extends StatelessWidget {
  ...
  Color _workoutColor() {
    final t = workoutType.toLowerCase();
    if (t.contains('chest')) return BugarAITheme.error;
    if (t.contains('back') || t.contains('pull')) return Colors.blue;
    if (t.contains('leg') || t.contains('lower')) return BugarAITheme.success;
    if (t.contains('shoulder')) return Colors.purple;
    if (t.contains('arm')) return BugarAITheme.warning;
  ...
  Widget _buildStatusBadge() {
    ...
    final color = completed ? BugarAITheme.success : BugarAITheme.warning;
          ...
          child: Column(
            children: [
              Icon(Icons.info_outline,
                  size: 36, color: BugarAITheme.muted),
                    ...
                    child: Row(
                      children: [
                        ...
                        const Icon(Icons.check_circle,
                            size: 18, color: BugarAITheme.success),
                      ],
                    ),
                  );
                }),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  height: 34,
                  decoration: BoxDecoration(
                    color: BugarAITheme.primary.withValues(alpha: 0.16),
                    borderRadius: BorderRadius.circular(8),
                  ),
                  child: Center(
                    child: Text(
