        ...
        children: [
          ...
          Row(
            children: ['All', 'Beginner', 'Intermediate', 'Advanced']
              ...
              switch (diff) {
                case 'Beginner':
                  diffColor = BugarAITheme.success;
                  break;
                case 'Intermediate':
                  diffColor = BugarAITheme.warning;
                  break;
                case 'Advanced':
                  diffColor = BugarAITheme.error;
                  break;
                default:
                  diffColor = BugarAITheme.muted;
              }
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(Icons.local_fire_department,
                                  size: 14, color: BugarAITheme.hot),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  _buildTag(
                                      exercise.equipment, BugarAITheme.teal),
                    ...
                    Row(
                      children: [
                        Icon(Icons.info_outline,
                            size: 14, color: BugarAITheme.muted),
                        const SizedBox(width: 6),
                        Expanded(
                          child: Text(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _buildInfoChip(
                            Icons.build, equipment, BugarAITheme.teal),
