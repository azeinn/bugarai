                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.bookmark_border,
                        size: 52, color: BugarAITheme.muted),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          runSpacing: 8,
                          children: [
                            _infoTag('${meal.protein}g P', BugarAITheme.teal),
                            _infoTag('${meal.carbs}g C', BugarAITheme.warning),
                            _infoTag('${meal.fats}g F', Colors.purple),
                            _infoTag(meal.mealType.toUpperCase(), BugarAITheme.primary),
                          ],
                        ),
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.circle,
                                    size: 6, color: BugarAITheme.muted),
