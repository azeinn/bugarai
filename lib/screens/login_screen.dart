      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: RadialGradient(
            ...
            radius: 1.2,
            colors: [Color(0xFF0D1530), BugarAITheme.bg],
          ),
        ),
        child: SafeArea(
                            ...
                            Row(
                              children: [
                                SizedBox(
                                  ...
                                  child: Checkbox(
                                    value: rememberMe,
                                    activeColor: BugarAITheme.primary,
                                ...
                                Text(
                                  ...
                                  style: const TextStyle(
                                      color: BugarAITheme.muted, fontSize: 12),
                                ),
                                const Spacer(),
                                TextButton(
                            ...
                            SizedBox(
                              ...
                              child: FilledButton(
                                ...
                                style: FilledButton.styleFrom(
                                  ...
                                  BugarAITheme.primary.withValues(alpha: 0.35),
                                  padding:
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: const TextStyle(
                                      color: BugarAITheme.muted, fontSize: 13),
                                ),
                                TextButton(
  ...
  Widget _buildLogo() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: BugarAITheme.primary.withValues(alpha: 0.5),
            blurRadius: 100,
      ...
      child: ClipOval(
        child: Image.asset(
           'assets/images/bugarai_logo.png',
          fit: BoxFit.contain,
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    ...
                    BugarAITheme.primary.withValues(alpha: 0.7),
                  ],
                ),
                shape: BoxShape.circle,
              ),
  ...
  Widget _buildTextField({
    ...
    return Container(
      ...
      child: TextField(
        ...
        style: const TextStyle(color: BugarAITheme.text),
        decoration: InputDecoration(
          border: InputBorder.none,
          prefixIcon: Icon(icon, color: BugarAITheme.muted),
                ...
                Image.network(
                  ...
                  errorBuilder: (context, error, stackTrace) {
                    return const Icon(Icons.g_mobiledata,
                        color: BugarAITheme.error, size: 24);
                  },
                ),
                const SizedBox(width: 10),
                Text(
