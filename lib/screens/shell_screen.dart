    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          selectedItemColor: BugarAITheme.primary,
                ...
                Row(
                  children: [
                    Container(
                      ...
                      height: 8,
                      decoration: BoxDecoration(
                        color: _isLoading ? BugarAITheme.warning : BugarAITheme.success,
  ...
  Widget _buildQuickActions() {
    return Container(
      ...
      child: ListView(
        ...
        children: [
          _buildQuickChip('💪', AppStrings.get('chat_workout'), 'Rencana workout terbaik untuk hari ini'),
          _buildQuickChip('🍽️', AppStrings.get('chat_diet'), 'Buatkan rencana diet saya'),
          _buildQuickChip('🔥', AppStrings.get('chat_motivate'), 'Motivasi saya!'),
          _buildQuickChip('📉', AppStrings.get('chat_weight_loss'), 'Tips menurunkan berat badan'),
          _buildQuickChip('💪', AppStrings.get('chat_muscle_gain'), 'Cara membentuk otot?'),
          _buildQuickChip('💧', AppStrings.get('chat_hydration'), 'Berapa banyak air yang harus diminum?'),
          _buildQuickChip('😴', AppStrings.get('chat_recovery'), 'Tips pemulihan'),
        ],
      ),
    );
  }
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: isUser
                        ? BugarAITheme.primary.withValues(alpha: 0.3)
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        return Container(
          ...
          height: size,
          decoration: BoxDecoration(
            color: BugarAITheme.primary.withValues(alpha: opacity),
            shape: BoxShape.circle,
          ),
        );
      },
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.psychology, color: BugarAITheme.primary, size: 24),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: Text(
  ...
  void _showClearChatDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            const Icon(Icons.delete_outline, color: BugarAITheme.error),
            const SizedBox(width: 8),
            Expanded(
              child: Text(
