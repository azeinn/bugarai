...
class _ProfileScreenState extends State<ProfileScreen> {
            ...
            children: [
              ...
              ListTile(
                ...
                leading: Container(
                  ...
                  child: const Icon(Icons.camera_alt, color: BugarAITheme.primary),
                ),
              ...
              if (_photoBase64 != null) ...[
                ...
                ListTile(
                  ...
                  leading: Container(
                    padding: const EdgeInsets.all(10),
                    decoration: BoxDecoration(
                      color: BugarAITheme.error.withValues(alpha: 0.2),
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: const Icon(Icons.delete, color: BugarAITheme.error),
                  ),
                  title: Text(AppStrings.get('profile_remove'), style: TextStyle(color: BugarAITheme.error)),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: BugarAITheme.primary, width: 3),
                  ),
                  child: ClipOval(
  ...
  Widget _buildAvatarContent() {
    if (_isUploadingPhoto) {
      return const Center(
        child: CircularProgressIndicator(color: BugarAITheme.primary, strokeWidth: 3),
      );
    }
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Row(children: [
                const Icon(Icons.person_outline, color: BugarAITheme.primary),
                const SizedBox(width: 8),
                Text(
  ...
  Widget _buildStatItem(IconData icon, String label, String value) {
    return Expanded(
      child: Column(
        children: [
          Icon(icon, color: BugarAITheme.primary, size: 24),
          const SizedBox(height: 8),
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Row(children: [
                const Icon(Icons.track_changes, color: BugarAITheme.hot),
                const SizedBox(width: 8),
                Text(
          ...
          const SizedBox(height: 16),
          _buildGoalRow(Icons.local_fire_department, 'Calories', '$_caloriesGoal kcal', BugarAITheme.hot),
          const Divider(height: 24, color: Colors.white12),
          _buildGoalRow(Icons.egg_alt, 'Protein', '$_proteinGoal g', BugarAITheme.teal),
          const Divider(height: 24, color: Colors.white12),
        ...
        children: [
          ...
          if (_googleFitError.isNotEmpty && !isConnected) ...[
            ...
            Container(
              ...
              padding: const EdgeInsets.all(10),
              decoration: BoxDecoration(
                color: BugarAITheme.warning.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(8),
              ),
              child: Row(
                children: [
                  const Icon(Icons.info_outline, color: BugarAITheme.warning, size: 16),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(_googleFitError, style: const TextStyle(color: BugarAITheme.warning, fontSize: 12)),
                  ),
                ],
              ),
            ),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: isConnected ? BugarAITheme.error.withValues(alpha: 0.8) : Colors.greenAccent,
        ...
        children: [
          ...
          ListTile(
            ...
            leading: Container(
              padding: const EdgeInsets.all(8),
              decoration: BoxDecoration(
                color: BugarAITheme.warning.withValues(alpha: 0.2),
                borderRadius: BorderRadius.circular(10),
              ),
              child: const Icon(Icons.notifications, color: BugarAITheme.warning, size: 20),
            ),
          ...
          ListTile(
            ...
            leading: Container(
              ...
              child: const Icon(Icons.language, color: BugarAITheme.primary, size: 20),
            ),
          ...
          ListTile(
            ...
            leading: Container(
              ...
              child: const Icon(Icons.delete_forever, color: BugarAITheme.error, size: 20),
            ),
            title: Text(
  ...
  Widget _buildLogoutButton() {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: BugarAITheme.error,
          padding: const EdgeInsets.symmetric(vertical: 14),
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        ),
      ),
  ...
  Widget _buildDeleteAccountButton() {
    return SizedBox(
      ...
      child: OutlinedButton.icon(
        ...
        icon: const Icon(Icons.delete_forever, color: BugarAITheme.error),
        label: Text(
          AppStrings.get('profile_delete'),
          style: const TextStyle(color: BugarAITheme.error, fontWeight: FontWeight.bold),
        ),
        style: OutlinedButton.styleFrom(
          side: const BorderSide(color: BugarAITheme.error),
          padding: const EdgeInsets.symmetric(vertical: 14),
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        ),
      ),
  ...
  void _showDeleteAccountDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: const Color(0xFF1A1A1A),
        title: Row(children: [
          const Icon(Icons.warning, color: BugarAITheme.error),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
  ...
  Future<void> _deleteAccount() async {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Row(
          children: [
            const CircularProgressIndicator(color: BugarAITheme.error),
  ...
  InputDecoration _inputDecoration(String label, IconData icon) {
    return InputDecoration(
      ...
      prefixIcon: Icon(icon, color: BugarAITheme.primary),
      filled: true,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Row(children: [
          Icon(Icons.fitness_center, color: BugarAITheme.primary),
          SizedBox(width: 8),
          Text('BugarAI'),
        ]),
