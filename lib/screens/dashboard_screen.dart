...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: BugarAITheme.bg,
      body: SafeArea(
        ...
        if (_isLoading)
          const SizedBox(
            ...
            child: CircularProgressIndicator(
                strokeWidth: 2, color: BugarAITheme.primary),
          )
        else
          Container(
            width: 44,
            ...
            child: const Icon(Icons.notifications_outlined,
                color: BugarAITheme.primary, size: 22),
          ),
      ],
    );
  }
  ...
  Color _getStepStatusColor() {
    if (!_stepCounterHasPermission) return BugarAITheme.warning;
      ...
      child: Column(
        children: [
                      ...
                      children: [
                        ...
                        if (_stepCounterService.isUsingHealthConnect)
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: BugarAITheme.success.withValues(alpha: 0.2),
                            ...
                            child: const Row(
                              ...
                              children: [
                                Icon(Icons.cloud_done,
                                    size: 10, color: BugarAITheme.success),
                                SizedBox(width: 3),
                                Text(
                                  'SYNC',
                                  style: TextStyle(
              ...
              if (!_stepCounterHasPermission)
                IconButton(
                  icon: const Icon(Icons.warning_amber,
                      color: BugarAITheme.warning, size: 22),
                    ...
                    Wrap(
                      ...
                      children: [
                        _buildMiniStat(Icons.local_fire_department,
                            '${_stepsCalories.round()}', 'kcal', BugarAITheme.warning),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: goalAchieved
                  ? BugarAITheme.success.withValues(alpha: 0.15)
            ...
            child: Row(
              children: [
                Icon(
                  ...
                  color: goalAchieved ? BugarAITheme.success : Colors.grey,
                  size: 16,
                ),
                const SizedBox(width: 8),
                Expanded(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _stepCounterService.isUsingHealthConnect
                        ? BugarAITheme.success.withValues(alpha: 0.1)
    ...
    return FGCard(
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.local_fire_department,
                  color: BugarAITheme.hot, size: 20),
              const SizedBox(width: 8),
              Text(
          ...
          const SizedBox(height: 12),
          FGLinearProgress(value: progress, color: BugarAITheme.hot),
        ],
      ),
    );
  }
          ...
          Row(
            children: [
              const Icon(Icons.track_changes,
                  color: BugarAITheme.primary, size: 20),
              const SizedBox(width: 8),
              Text(
          ...
          Row(
            children: [
              const Icon(Icons.calendar_today,
                  color: BugarAITheme.primary, size: 18),
              const SizedBox(width: 8),
              Text(
                  ...
                  children: [
                    if (workoutCount > 0)
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 10,
                          color: isToday ? BugarAITheme.primary : Colors.grey,
                          fontWeight: FontWeight.w600,
                        ),
                      ),
                    const SizedBox(height: 4),
                    AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        gradient: isToday || workoutCount > 0
                          ...
                          colors: [
                            BugarAITheme.primary,
                            BugarAITheme.primary.withValues(alpha: 0.6),
                          ],
  ...
  void _showAddStepsDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            const Icon(Icons.directions_walk, color: BugarAITheme.primary),
            const SizedBox(width: 8),
  ...
  void _showAddActiveMinutesDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            const Icon(Icons.timer, color: BugarAITheme.hot),
            const SizedBox(width: 8),
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style:
            ElevatedButton.styleFrom(backgroundColor: BugarAITheme.hot),
            child: Text(AppStrings.get('save'),
                style: const TextStyle(color: Colors.white)),
          ),
        ],
...
class _StepRingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final progressColor =
    isGoalAchieved ? Colors.amber : BugarAITheme.primary;
    final paint = Paint()
