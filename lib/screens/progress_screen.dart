...
Berikan umpan balik motivasi singkat (maksimal 2-3 baris) dengan tips.''',
            ...
            FGCard(
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.bar_chart, color: BugarAITheme.primary, size: 20),
            ...
            FGCard(
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.local_fire_department, color: BugarAITheme.hot, size: 20),
                      const SizedBox(width: 8),
                      const Text(
                        'Calories This Week',
                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                      ...
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                        decoration: BoxDecoration(
                          color: BugarAITheme.hot.withValues(alpha: 0.2),
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: Text(
                          'Goal: $_caloriesGoal',
                            ...
                            sideTitles: SideTitles(
                              ...
                              getTitlesWidget: (value, meta) {
                                ...
                                return Padding(
                                  ...
                                  child: Text(
                                    days[value.toInt()],
                                    style: TextStyle(color: BugarAITheme.muted, fontSize: 10),
                                  ),
                                );
                              },
                            ),
                          ...
                          return BarChartGroupData(
                            ...
                            barRods: [
                              BarChartRodData(
                                toY: cals > 0 ? cals : 50,
                                color: cals == 0
                                    ? BugarAITheme.hot.withValues(alpha: 0.2)
                                    : percentage >= 1.0
                                    ? BugarAITheme.success
                                    : percentage >= 0.7
                                    ? BugarAITheme.hot
                                    : BugarAITheme.hot.withValues(alpha: 0.6),
                                width: 28,
                                borderRadius: const BorderRadius.vertical(top: Radius.circular(6)),
                              ),
                            ],
            ...
            FGCard(
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.restaurant, color: BugarAITheme.teal, size: 20),
                      const SizedBox(width: 8),
                      const Text(
                        'Protein This Week',
                        style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(Icons.monitor_weight, color: BugarAITheme.teal, size: 20),
                          const SizedBox(width: 8),
                          const Text(
                            'Weight Trend',
                            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                      ...
                      IconButton(
                        icon: const Icon(Icons.add_circle_outline, color: BugarAITheme.primary),
        ...
        LineChartData(
          ...
          lineBarsData: [
            LineChartBarData(
              ...
              belowBarData: BarAreaData(
                show: true,
                color: BugarAITheme.teal.withValues(alpha: 0.15),
              ),
            ),
          ],
          titlesData: FlTitlesData(
                ...
                getTitlesWidget: (value, meta) {
                  ...
                  return Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: BugarAITheme.muted, fontSize: 9),
                    ),
                  );
                },
              ),
  ...
  Color _weightTrendColor() {
    final diff = _weightHistory.last.weight - _weightHistory.first.weight;
    if (diff == 0) return BugarAITheme.muted;
    return diff < 0 ? BugarAITheme.success : BugarAITheme.warning;
  }
  ...
  Widget _buildDateRange() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: BugarAITheme.primary.withValues(alpha: 0.1),
        borderRadius: BorderRadius.circular(12),
      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.calendar_today, color: BugarAITheme.primary, size: 18),
          const SizedBox(width: 10),
          Text(
            '$startDate - $endDate',
            style: const TextStyle(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              ...
              BugarAITheme.warning.withValues(alpha: 0.05),
            ],
          ),
          borderRadius: BorderRadius.circular(12),
        ),
        ...
        children: [
          ...
          ..._weekData.reversed.map((data) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                color: isToday
                    ? BugarAITheme.primary.withValues(alpha: 0.1)
                    : BugarAITheme.card,
                borderRadius: BorderRadius.circular(12),
                border: isToday
                    ? Border.all(color: BugarAITheme.primary.withValues(alpha: 0.3))
                    : null,
              ),
              child: Row(
                children: [
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: isToday ? BugarAITheme.primary : Colors.white,
                            ),
                          ),
                          if (isToday)
                            Container(
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: data.calories > 0 ? BugarAITheme.hot : BugarAITheme.muted,
                        ),
                      ),
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 12,
                          color: data.protein > 0 ? BugarAITheme.teal : BugarAITheme.muted,
                        ),
                      ),
                    ],
                  ),
  ...
  Widget _buildAllTimeRow(IconData icon, String label, String value) {
    return Row(
      children: [
        Icon(icon, size: 20, color: BugarAITheme.primary),
        const SizedBox(width: 12),
        Expanded(
          child: Text(label, style: TextStyle(color: BugarAITheme.muted)),
        ),
        Text(
          value,
  ...
  void _showAddWeightDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: BugarAITheme.card,
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            labelText: 'Weight (kg)',
            labelStyle: TextStyle(color: BugarAITheme.muted),
