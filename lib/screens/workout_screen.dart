...
class _WorkoutScreenState extends State<WorkoutScreen>
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(color: BugarAITheme.muted, fontSize: 14),
            ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                subtitle,
                style: TextStyle(fontSize: 12, color: BugarAITheme.muted),
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
            ],
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: isRestDay
                ...
                : [BugarAITheme.primary, BugarAITheme.primary.withValues(alpha: 0.7)],
          ...
          boxShadow: isRestDay
              ...
              : [
            BoxShadow(
              color: BugarAITheme.primary.withValues(alpha: 0.4),
              blurRadius: 15,
  ...
  Widget _buildMuscleGroupsGrid() {
    final groups = [
      {'name': 'Chest', 'emoji': '🏋️', 'color': BugarAITheme.error, 'count': ExerciseData.chest.length},
      {'name': 'Back', 'emoji': '🔙', 'color': Colors.blue, 'count': ExerciseData.back.length},
      {'name': 'Legs', 'emoji': '🦵', 'color': BugarAITheme.success, 'count': ExerciseData.legs.length},
      {'name': 'Arms', 'emoji': '💪', 'color': BugarAITheme.warning, 'count': ExerciseData.biceps.length + ExerciseData.triceps.length},
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              plan.subtitle,
              style: TextStyle(fontSize: 11, color: BugarAITheme.muted),
              maxLines: 2,
              overflow: TextOverflow.ellipsis,
            ),
            const Spacer(),
            Row(
              children: [
                Icon(Icons.fitness_center, size: 12, color: BugarAITheme.muted),
                        ...
                        child: Row(
                          children: [
                            Container(
                              padding: const EdgeInsets.all(10),
                              decoration: BoxDecoration(
                                color: BugarAITheme.teal.withValues(alpha: 0.2),
                                borderRadius: BorderRadius.circular(10),
                              ),
                              child: const Icon(Icons.bookmark, color: BugarAITheme.teal, size: 20),
                            ),
                            ...
                            Icon(Icons.arrow_forward_ios, size: 14, color: BugarAITheme.muted),
                          ],
                        ),
                      ),
                    );
                  ...
                  FGCard(
                    child: Center(
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Icon(Icons.library_add, size: 36, color: BugarAITheme.muted),
                            const SizedBox(height: 8),
                            Text(
                              AppStrings.get('library_empty'),
                              style: TextStyle(color: BugarAITheme.muted, fontSize: 13),
                            ),
                            const SizedBox(height: 4),
                            Text(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: BugarAITheme.primary.withValues(alpha: 0.3)),
                  ),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      const Icon(Icons.add, color: BugarAITheme.primary, size: 18),
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.library_books, color: BugarAITheme.muted, size: 18),
                      const SizedBox(width: 6),
                      Text(
                        'View All',
                        style: TextStyle(
          ...
          return FGCard(
            child: Center(
              child: Padding(
                ...
                child: Column(
                  children: [
                    Icon(Icons.fitness_center, size: 40, color: BugarAITheme.muted),
                    const SizedBox(height: 8),
                    Text(
                      ...
                      Column(
                        children: [
                          Icon(
                            ...
                            color: status == 'completed' ? BugarAITheme.success : BugarAITheme.warning,
                            size: 22,
                          ),
                          const SizedBox(height: 4),
                          Text(
  ...
  Widget _buildMiniStat(IconData icon, String text) {
    return Row(
      ...
      children: [
        Icon(icon, size: 12, color: BugarAITheme.muted),
              ...
              children: [
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<Exercise>(
                      ...
                      hint: Text(AppStrings.get('workout_choose_exercise'), style: TextStyle(color: BugarAITheme.muted)),
                      dropdownColor: BugarAITheme.cardDark,
                ...
                if (selectedExercise != null && selectedExercise!.hasGif) ...[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(color: BugarAITheme.primary.withValues(alpha: 0.2)),
                    ),
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(12),
                      child: Image.asset(
                ...
                if (selectedExercise != null) ...[
                  ...
                  Wrap(
                    ...
                    children: selectedExercise!.musclesWorked.map((m) => Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                      decoration: BoxDecoration(color: BugarAITheme.success.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(6)),
                      child: Text('💪 $m', style: const TextStyle(fontSize: 11, color: BugarAITheme.success)),
                    )).toList(),
                  ),
                ],
                    ...
                    return Expanded(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: sel ? BugarAITheme.primary : BugarAITheme.background,
                            borderRadius: BorderRadius.circular(10),
                            border: Border.all(color: sel ? BugarAITheme.primary : Colors.white24),
                          ),
                          child: Center(child: Text('$s', style: TextStyle(fontWeight: FontWeight.bold, color: sel ? Colors.white : BugarAITheme.muted))),
                        ),
                      ),
                    );
                  }).toList(),
                  ...
                  children: ExerciseData.repsOptions.map((r) {
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: sel ? BugarAITheme.teal : BugarAITheme.background,
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(color: sel ? BugarAITheme.teal : Colors.white24),
                        ),
                        child: Center(child: Text('$r', style: TextStyle(fontWeight: FontWeight.bold, color: sel ? Colors.white : BugarAITheme.muted))),
                      ),
                    );
                  }).toList(),
                ),
                ...
                Row(
                  children: [
                    IconButton(
                      ...
                      icon: Container(
                        padding: const EdgeInsets.all(8),
                        decoration: BoxDecoration(color: BugarAITheme.hot.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(8)),
                        child: const Icon(Icons.remove, color: BugarAITheme.hot),
                      ),
                    ),
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          filled: true, fillColor: BugarAITheme.background,
                          border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
                          suffixText: 'kg', suffixStyle: TextStyle(color: BugarAITheme.muted),
                        ),
                      ),
                    ),
                    IconButton(
                      ...
                      icon: Container(
                        padding: const EdgeInsets.all(8),
                        decoration: BoxDecoration(color: BugarAITheme.success.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(8)),
                        child: const Icon(Icons.add, color: BugarAITheme.success),
                      ),
                    ),
                  ],
                ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: selectedExercise == null ? Colors.grey : BugarAITheme.primary,
          ...
          actions: [
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(backgroundColor: BugarAITheme.primary),
                child: Text(
                  AppStrings.get('done'),
  ...
  Widget _completionStat(String emoji, String value, String label) {
    return Column(
      children: [
        Text(emoji, style: const TextStyle(fontSize: 28)),
        const SizedBox(height: 4),
        Text(value, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: BugarAITheme.primary)),
        Text(label, style: TextStyle(color: BugarAITheme.muted, fontSize: 12)),
      ],
    );
  }
        ...
        actions: [
          TextButton(
            ...
            child: Text(
              ...
              style: TextStyle(color: BugarAITheme.error),
            ),
          ),
          ElevatedButton(
            onPressed: () { Navigator.pop(context); _finishWorkout(); },
            style: ElevatedButton.styleFrom(backgroundColor: BugarAITheme.success),
            child: Text(
    ...
    return Scaffold(
          ...
          if (_isWorkoutStarted)
            TextButton(
              ...
              child: Text(
                ...
                style: TextStyle(color: BugarAITheme.success, fontWeight: FontWeight.bold),
              ),
            ),
        ],
      ),
      body: _isLoading
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            CircularProgressIndicator(color: BugarAITheme.primary),
            const SizedBox(height: 20),
            Text(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    width: double.infinity,
                    padding: const EdgeInsets.all(14),
                    decoration: BoxDecoration(color: BugarAITheme.background, borderRadius: BorderRadius.circular(12)),
            ...
            if (!_isWorkoutStarted)
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: BugarAITheme.success,
                    padding: const EdgeInsets.symmetric(vertical: 16),
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                  ),
                ),
            ...
            if (_isWorkoutStarted) ...[
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(color: BugarAITheme.success.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(20)),
                    child: Row(
                      children: [
                        const Icon(Icons.timer, size: 16, color: BugarAITheme.success),
                        const SizedBox(width: 4),
                        StreamBuilder(
                          stream: Stream.periodic(const Duration(seconds: 1)),
                          builder: (c, s) {
                            final d = _startTime != null ? DateTime.now().difference(_startTime!).inMinutes : 0;
                            return Text('$d min', style: const TextStyle(color: BugarAITheme.success, fontWeight: FontWeight.bold));
                          },
                        ),
                      ],
                    ),
                ...
                FGCard(
                  child: Center(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.add_circle_outline, size: 40, color: BugarAITheme.muted),
                          const SizedBox(height: 8),
                          Text(
                            AppStrings.get('workout_no_sets'),
                            style: TextStyle(color: BugarAITheme.muted),
                    ...
                    child: FGCard(
                      child: Row(
                        children: [
                          Container(
                            width: 36, height: 36,
                            decoration: BoxDecoration(color: BugarAITheme.primary.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(8)),
                            child: Center(child: Text('${i + 1}', style: const TextStyle(fontWeight: FontWeight.bold, color: BugarAITheme.primary))),
                          ),
                          const SizedBox(width: 12),
                          Expanded(
                            child: Column(
                          ...
                          const Icon(Icons.check_circle, color: BugarAITheme.success, size: 22),
                        ],
                      ),
                    ),
                  );
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text(
                    AppStrings.get('workout_finish'),
                    style: TextStyle(color: BugarAITheme.success, fontWeight: FontWeight.bold, fontSize: 16),
                  ),
