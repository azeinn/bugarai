    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          indicatorColor: BugarAITheme.primary,
          labelColor: BugarAITheme.primary,
          unselectedLabelColor: BugarAITheme.muted,
          tabs: [
            Tab(
              child: Text(
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [BugarAITheme.primary, Colors.purple],
                  ),
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    backgroundColor: Colors.white.withValues(alpha: 0.1),
                    valueColor: AlwaysStoppedAnimation<Color>(
                      completed == total ? BugarAITheme.success : BugarAITheme.primary,
                    ),
                    minHeight: 10,
                  ),
                ),
  ...
  Widget _buildChallengeCard(Challenge challenge) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isCompleted
              ? BugarAITheme.success.withValues(alpha: 0.3)
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: isCompleted
                      ? BugarAITheme.success.withValues(alpha: 0.2)
                      : BugarAITheme.primary.withValues(alpha: 0.2),
                        ...
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                              color: isCompleted ? BugarAITheme.success : Colors.white,
                            ),
                          ),
                        ),
                        Container(
                          ...
                          child: Text(
                            '+${challenge.points} XP',
                            style: TextStyle(
                              color: isCompleted ? BugarAITheme.success : Colors.amber,
                              fontSize: 11,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
            ...
            children: [
              Expanded(
                child: ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    backgroundColor: Colors.white.withValues(alpha: 0.1),
                    valueColor: AlwaysStoppedAnimation<Color>(
                      isCompleted ? BugarAITheme.success : BugarAITheme.primary,
                    ),
                    minHeight: 8,
                  ),
                ),
              ...
              if (isCompleted)
                const Padding(
                  ...
                  child: Icon(Icons.check_circle, color: BugarAITheme.success, size: 20),
                ),
            ],
          ),
        ],
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: isUnlocked ? BugarAITheme.success : Colors.amber,
                  fontWeight: FontWeight.bold,
                ),
              ),
            ),
