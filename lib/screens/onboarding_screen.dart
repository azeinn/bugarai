      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              AnimatedSwitcher(
                ...
                child: Text(
                  ...
                  style: const TextStyle(color: BugarAITheme.muted),
                ),
              ),
            ],
          ),
          ...
          Text(
            ...
            style: const TextStyle(color: BugarAITheme.muted, fontSize: 14),
          ),
    ...
    return _pageWrapper(
      ...
      child: Column(
        children: [
          ...
          const Text('saal', style: TextStyle(color: BugarAITheme.muted)),
          const SizedBox(height: 24),
          SliderTheme(
            data: SliderTheme.of(context).copyWith(
              activeTrackColor: BugarAITheme.primary,
              inactiveTrackColor: BugarAITheme.card2,
              thumbColor: BugarAITheme.primary,
              overlayColor: BugarAITheme.primary.withValues(alpha: 0.2),
            ),
            child: Slider(
              value: age.toDouble(),
              min: 13,
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(label, style: const TextStyle(color: BugarAITheme.muted)),
              AnimatedSwitcher(
                duration: const Duration(milliseconds: 200),
                child: Text(
          ...
          SliderTheme(
            data: SliderTheme.of(context).copyWith(
              activeTrackColor: BugarAITheme.teal,
              inactiveTrackColor: BugarAITheme.card2,
              thumbColor: BugarAITheme.teal,
              overlayColor: BugarAITheme.teal.withValues(alpha: 0.2),
            ),
            child: Slider(
              value: value,
              min: min,
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      color: selected
                          ? BugarAITheme.text
                          : BugarAITheme.text.withValues(alpha: 0.85),
