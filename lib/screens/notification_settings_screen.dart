  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.notifications_active, color: BugarAITheme.primary),
            onPressed: () async {
      ...
      body: _isLoading
          ? const Center(child: CircularProgressIndicator(color: BugarAITheme.primary))
  ...
  Widget _buildNotificationCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: enabled ? BugarAITheme.primary.withValues(alpha: 0.3) : Colors.transparent,
        ),
      ),
      child: Column(
        children: [
          Row(
            children: [
              ...
              Switch(
                value: enabled,
                onChanged: onToggle,
                activeThumbColor: BugarAITheme.primary,
              ),
            ],
          ),
          if (enabled) ...[
  ...
  Widget _buildWaterReminderCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: _waterEnabled ? BugarAITheme.primary.withValues(alpha: 0.3) : Colors.transparent,
        ),
      ),
      child: Column(
        children: [
