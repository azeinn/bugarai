    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: selected ? BugarAITheme.primary : BugarAITheme.muted.withValues(alpha: 0.2),
          ),
        ),
        child: Text(
          label,
          style: TextStyle(
            color: selected ? Colors.white : BugarAITheme.muted,
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.fitness_center, color: BugarAITheme.primary),
            ),
            ...
            Icon(Icons.chevron_right, color: BugarAITheme.muted),
          ],
        ),
      ),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                exercise.categoryName,
                style: const TextStyle(color: BugarAITheme.primary, fontSize: 12, fontWeight: FontWeight.bold),
              ),
            ),
            ...
            if (exercise.muscles.isNotEmpty) ...[
              ...
              _chipsRow(exercise.muscles, BugarAITheme.primary),
              const SizedBox(height: 16),
            ],

            if (exercise.secondaryMuscles.isNotEmpty) ...[
              _sectionTitle(AppStrings.get('exercise_secondary_muscles')),
              _chipsRow(exercise.secondaryMuscles, BugarAITheme.teal),
              const SizedBox(height: 16),
            ],

            if (exercise.equipment.isNotEmpty) ...[
              _sectionTitle(AppStrings.get('exercise_equipment')),
              _chipsRow(exercise.equipment, BugarAITheme.warning),
              const SizedBox(height: 16),
            ],
            ...
            if (exercise.description.isNotEmpty) ...[
              ...
              Text(
                ...
                style: TextStyle(color: BugarAITheme.muted, fontSize: 14, height: 1.5),
              ),
            ],
          ],
        ),
    ...
    return Container(
      ...
      child: loading
        ...
        child: SizedBox(
          width: 28,
          height: 28,
          child: CircularProgressIndicator(strokeWidth: 2, color: BugarAITheme.primary),
        ),
      )
          : Icon(Icons.fitness_center, size: 64, color: BugarAITheme.muted.withValues(alpha: 0.4)),
    );
  }
